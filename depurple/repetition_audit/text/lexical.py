"""Shared word-level helpers for prose-quality detectors.

These helpers tokenize text, build sliding n-gram windows, compare token
sequences, and count content words so detectors share the same word-level
normalization.
