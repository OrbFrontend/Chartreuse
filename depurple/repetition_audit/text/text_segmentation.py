"""Shared paragraph, sentence, and dialogue segmentation for detectors.

This module is the single source of truth for detector-facing text splitting,
quote handling, and sentence terminator behavior.
